...
const steps = [
  {
    ...
    description: `Take 2 grams of your produce (vegetables or fruit) or take a small soil sample. Immerse the sample into water for 10 minutes to release pesticide residues.`,
    image: '/assets/p1.jpg',
  ...
  },
  {
    ...
    description: `Transfer 100μL of your sample extract into an Eppendorf tube. Using the Cell-Free kit, the reaction will begin immediately. `,
    image: '/assets/p2.jpg',
  ...
  },
  {
    ...
    description: `Place the reaction tube into the SmartBox. Ensure the lid is securely closed to block all ambient light. Switch on the internal blue LED excitation light.`,
